...
# add H4SiO4 to thermodynamic data base
reset() 
add.obigt("AS04") # add data from Apps and Spycher 2004
s_25C <- subcrt(c("SiO2", "H2O"), c(1, 2), T = 25)$out
with(
  s_25C, 
  mod.obigt("H4SiO4", formula = "H4SiO4", G = G, H = H, S = S, Cp = Cp, V = V, z = 0)
)
...
basis <- basis(c("Al+3", "H4SiO4", "K+", "H2O", "H+", "O2"))
